    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:3000/api/v1/booking/cart-delete/".concat(id)
          });
        case 3:
          res = _context2.sent;
          if (!res.data) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return _axios.default.post('http://127.0.0.1:3000/api/v1/tours/', {});
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post("http://127.0.0.1:3000/api/v1/booking/checkoutseccion/".concat(type) // {
          //   headers: {
          //     'Content-Type': 'application/json'
          //   },
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 14;
            _context.next = 17;
            return _axios.default.post('http://127.0.0.1:3000/api/v1/tours/', form);
          case 17:
            response = _context.sent;
            // Handle success
...
},{"./login":"login.js","./updatesettings":"updatesettings.js","./makeingtour":"makeingtour.js","axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./stripe":"stripe.js"}]},{},["index.js"], null)
