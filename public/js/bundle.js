...
})(
  {
    ...
    '../../node_modules/axios/lib/utils.js': [
      function(require, module, exports) {
        ...
        const hasOwnProperty = (({ hasOwnProperty }) => (obj, prop) =>
 ...
 */
      ...
      function(require, module, exports) {
        ...
        var deleterequest = (exports.deleterequest = /*#__PURE__*/ (function() {
          var _ref2 = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(id) {
              var res;
              return _regeneratorRuntime().wrap(
                  ...
                  while (1)
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'DELETE',
                          url: 'http://127.0.0.1:3000/api/v1/booking/cart-delete/'.concat(
                            id
                          )
                        });
                      case 3:
                  ...
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        _context.next = 3;
                        return _axios.default.post(
                          'http://127.0.0.1:3000/api/v1/booking/checkoutseccion/'.concat(
                            type
                          ) // {
                          //   headers: {
                          //     'Content-Type': 'application/json'
    ...
    'index.js': [
      function(require, module, exports) {
                      ...
                      while (1)
                        switch ((_context.prev = _context.next)) {
                          case 0:
                            ...
                            form.append(
                              'images',
                              document.getElementById('images1').files[0]
                            );
                            form.append(
                              'images',
                              document.getElementById('images2').files[0]
                            );
                            form.append(
                              'images',
                              document.getElementById('images3').files[0]
                            );
                            console.log(form);
        ...
        if (updatedfrorm)
          updatedfrorm.addEventListener('submit', function(e) {
            e.preventDefault();
        ...
        if (book_tour)
          book_tour.addEventListener(
            'submit',
            /*#__PURE__*/ (function() {
              var _ref3 = _asyncToGenerator(
                /*#__PURE__*/ _regeneratorRuntime().mark(function _callee3(e) {
                  var type;
