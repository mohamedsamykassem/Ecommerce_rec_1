...
exports.login = exports.deleterequest = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          (0, _alerts.showAlert)('success', 'you are login successfly ✔');
...
var deleterequest = exports.deleterequest = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "/api/v1/booking/cart-delete/".concat(id)
          });
        case 3:
          res = _context2.sent;
          if (!res.data) {
            (0, _alerts.showAlert)('success', ' success deleted ✔');
            window.setTimeout(function () {
  ...
  return function deleterequest(_x3) {
...
exports.updatepassword = exports.update = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'you are updated successfly ✔');
            window.setTimeout(function () {
...
var updatepassword = exports.updatepassword = /*#__PURE__*/function () {
  ...
  return function updatepassword(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"makeingtour.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var makingtour = exports.makingtour = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return _axios.default.post('/api/v1/tours/', {});
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'YOUR PRODECT  MAKED SUCCESSFLY  ✔');
            window.setTimeout(function () {
              window.location.assign('/');
            }, 1500);
          }
...
var _makeingtour = require("./makeingtour");
var _alerts = require("./alerts");
...
var book_tour = document.getElementById('checkout-form');
var delete_btn = document.getElementById('delete-btn');
var searchbox = document.querySelector('.search-box');
var searchQuery = document.getElementById('search-input').value;
var searchbtn = document.getElementById('search-btn');
var loadbtn = document.querySelector('load_button');
var load_btn = document.getElementById('load-more-btn');
if (maketour) {
  maketour.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 14;
            _context.next = 17;
            return _axios.default.post('/api/v1/tours/', form);
          case 17:
            _response = _context.sent;
            // Handle success
            (0, _alerts.showAlert)('success', 'YOUR PRODUCT WAS CREATED SUCCESSFULLY ✔');
            setTimeout(function () {
              window.location.assign('/');
            }, 1500);
            _context.next = 26;
...
if (logout) logout.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var res;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
...
if (signupform) {
  signupform.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var name, email, password, passwordConfirm, _response2;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 13:
            ...
            console.log(_context3.t0); // Log the error for debugging
          case 17:
          case "end":
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          document.querySelector('.btn--small.btn--pass').textContent = 'save password';
...
for (var i = 0; i < 400; i++) {
  var buttonId = "delete-btn-".concat(i);
  var button = document.getElementById(buttonId);
  if (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      var id = e.target.dataset.id;
      (0, _login.deleterequest)(id);
      // Add your delete functionality here
    });
  }
}
document.addEventListener('DOMContentLoaded', function () {
  var quantityInputs = document.querySelectorAll('.card__quantity');
...
function updateBookingQuantity(id, newQuantity) {
  ...
  // Example using fetch:
  (0, _axios.default)("/api/v1/booking/cart-update/".concat(id), {
    method: 'PATCH',
    headers: {
      'Content-Type': 'application/json'
    },
...
/////////////////////////////////////////////////////////////////
//search box
if (searchbtn) searchbtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
  var searchQuery;
    ...
    while (1) switch (_context6.prev = _context6.next) {
      case 0:
        ...
        try {
          ...
          // });
          window.location.href = "/api/v1/tours?name=".concat(searchQuery);
...
if (load_btn || loadbtn) {
  ...
  load_btn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    var limit;
      ...
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          try {
            ...
            window.location.href = "/api/v1/tours?page=".concat(page, "&limit=").concat(limit);
            //console.log(response.data.tours); // This will be an array of tours matching the search query
